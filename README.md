...
The plan is to ideally move the ASM code to our own separate custom DLL. I have created the [dll-migration](https://github.com/Celarious/OpenShores-IP-Patch/tree/dll-migration) branch for this.
